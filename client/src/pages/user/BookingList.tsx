      ...
      <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
        ...
        <div className="relative w-full md:w-1/2">
          ...
          <input
            ...
            className="w-full py-3 pl-12 pr-10 rounded-full bg-white shadow-md focus:ring-2 focus:ring-blue-700 outline-none text-gray-700"
          />
          {searchQuery && (
            <button
              onClick={() => {
          ...
          <select
            ...
            onChange={(e) => {
              if (e.target.value === "earliest")
                setFilters({ sortBy: "moveInDate", sortOrder: "asc", page: 1 });
              else if (e.target.value === "latest")
                setFilters({ sortBy: "moveInDate", sortOrder: "desc", page: 1 });
            }}
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {bookings.map((b) => (
          <div
            ...
            className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow p-4 flex gap-4 items-center cursor-pointer"
          >
            {/* Property Image */}
